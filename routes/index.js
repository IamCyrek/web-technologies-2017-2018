...
router.get(constants.PATH_BY_SORT, validateParams(schemas.sortSchema), controllers.sorting);
router.get(constants.PATH_BY_SORT_WITH_DIRECTION, validateParams(schemas.sortWithDirectionSchema),
